...
if (!m.fromMem && m.text.match(/(@218910297961|@218943821774|هارون|بوت|:v)/gi)) {
...
if (msg) return conn.sendMessage(m.chat, {
  ...
  contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      newsletterJid: '120363419975982440@newsletter',
      serverMessageId: '',
      newsletterName: '𝙷𝙰𝚁𝙾𝙽 𝙱𝙾𝚃'
    },
    externalAdReply: {
      mediaUrl: null,
      mediaType: 1,
